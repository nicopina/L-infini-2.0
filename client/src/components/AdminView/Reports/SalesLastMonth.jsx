...
function SalesLastMonth(params) {
  ...
  var last_day_month = new Date(
    actual_date.getFullYear(),
    actual_date.getMonth() + 1,
    0
  );
  ...
  var last_day_last_month = new Date(
    actual_date.getFullYear(),
  ...
  var first_day_last_month = new Date(
    actual_date.getFullYear(),
    actual_date.getMonth() - 1,
    1,
    0,
  ...
  var equivalent_day_last_month = Math.round(
    last_day_last_month.getDate() * month_progress
  );

  var final_date = new Date(
    actual_date.getFullYear(),
    actual_date.getMonth() - 1,
    equivalent_day_last_month,
    0,
    0,
    0,
    0
  ...
  React.useEffect(() => {
    getProfitByDateRange(
      first_day_last_month.getTime() -
        first_day_last_month.getTimezoneOffset() * 60000,
  ...
  formatedDiferencia = formatedDiferencia
    .toString()
    .replace(/\B(?=(\d{3})+(?!\d))/g, ".");
  ...
  return (
    <div>
      <h4 style={{ textAlign: "center", color: "black" }}>
        Comparación a la fecha con el mes anterior
      </h4>
